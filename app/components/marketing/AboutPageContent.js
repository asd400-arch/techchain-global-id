...
const COPY = {
  id: {
    heroKicker: 'Profil Perusahaan',
    heroTitle1: 'Memimpin di Bidang',
    heroTitle2: 'Dukungan Teknologi',
    heroSub: 'Sejak 2016, memberikan keunggulan layanan teknologi dari Indonesia ke seluruh dunia.',
    journey: 'Perjalanan Kami',
    journeyTitle: 'Satu Dekade Pertumbuhan',
    global: 'Jaringan Global',
    globalTitle: 'Kehadiran Kami di Asia-Pasifik',
    ctaTitle: 'Siap Bermitra Dengan Kami?',
    ctaSub: 'Bergabunglah dengan bisnis di 9 negara yang mempercayai Tech Chain Global',
    ctaButton: 'Hubungi Kami →',
    footer: '© 2026 Tech Chain Global. Seluruh hak cipta dilindungi.',
  },
  en: {
    heroKicker: 'Company profile',
    heroTitle1: 'Leading in',
    heroTitle2: 'technology support',
    heroSub: 'Since 2016, delivering technology service excellence from Indonesia across the Asia-Pacific region.',
    journey: 'Our journey',
    journeyTitle: 'A decade of growth',
    global: 'Global network',
    globalTitle: 'Our presence in Asia-Pacific',
    ctaTitle: 'Ready to partner with us?',
    ctaSub: 'Join businesses in 9 countries that trust Tech Chain Global.',
...
const VISION = {
  ...
  en: [
    { icon: '⚙️', title: 'Technology leadership', desc: 'Leading technology support across semiconductor, data centre, telecommunications, and healthcare sectors.' },
    { icon: '🤖', title: 'AI & automation', desc: 'Continuous investment in capabilities aligned with modern AI platforms and automation solutions.' },
    { icon: '🌱', title: 'Sustainable future', desc: 'Building long-term value through technology for the next generation.' },
  ],
};
...
const TIMELINE = {
  ...
  en: [
    { year: '2016', event: 'Founded in Indonesia — headquarters', icon: '🇮🇩' },
    { year: '2017', event: 'Indonesia expansion — national network with 16 locations', icon: '🇮🇩' },
    { year: '2018', event: 'Semiconductor & telecom support launched', icon: '⚙️' },
    { year: '2020', event: 'E-commerce hub established in Indonesia', icon: '🛒' },
    { year: '2021', event: 'Healthcare operations & vaccine logistics launched', icon: '🏥' },
    { year: '2022', event: 'Expansion to Malaysia & Thailand', icon: '🌏' },
    { year: '2023', event: 'Indonesia fab technical support & automation', icon: '🤖' },
    { year: '2024', event: 'India expansion — Delhi, Mumbai, Chennai', icon: '🇮🇳' },
    { year: '2025', event: 'Data centre support services launched', icon: '🖥️' },
  ],
};
      ...
      <section style={{ padding: m ? '50px 16px' : '80px 40px', background: '#0e1f3d' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: m ? '40px' : '60px' }}>
            <span style={{ color: '#00d4ff', fontSize: '14px', fontWeight: '600', letterSpacing: '3px', textTransform: 'uppercase' }}>{t.journey}</span>
            <h2 style={{ fontSize: m ? '28px' : '40px', fontWeight: '800', color: 'white', marginTop: '12px' }}>{t.journeyTitle}</h2>
          </div>
          {timeline.map((item, i) => (
      ...
      <section style={{ padding: pad, background: '#0a1628' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            <span style={{ color: '#00d4ff', fontSize: '14px', fontWeight: '600', letterSpacing: '3px', textTransform: 'uppercase' }}>{t.global}</span>
            <h2 style={{ fontSize: m ? '28px' : '40px', fontWeight: '800', color: 'white', marginTop: '12px' }}>{t.globalTitle}</h2>
          </div>
